...
if __name__== "__main__":
    ...
    print('Valor iphone 1 atualziado:', iphone1.get_valor())
    iphone1.aumenta_valor(1000.00)
    print('Valor iphone 1 com aumento:', iphone1.get_valor())
    iphone1.diminui_valor(500.00)
    print('Valor iphone 1 com desconto:', iphone1.get_valor())
