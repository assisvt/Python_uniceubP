...
class Point():
    ...
    def distancia_origem(self):                 # Método funcional
        distancia = math.sqrt((self.x - 0)**2 + (self.y - 0)**2)
        return distancia
...
if __name__ == '__main__':       
    ...
    # ou print("Objeto p1 da classe Point", p1.__str__())
